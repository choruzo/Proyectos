...
| **DevOps & CI/CD** | **Autotest CI/CD Pipeline** | Pipeline CI/CD completo para monitorización de tags Git, compilación de DVDs/ISOs, análisis SonarQube, gestión de VMs y despliegue SSH automatizado, con Web UI de monitorización. | `Python`, `Flask`, `Alpine.js`, `Tailwind`, `SonarQube`, `vCenter` | [📄 Ver Detalle](./cicd/Autotest) |
