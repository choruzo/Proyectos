...
|----|----------|-------------|------------|
| 0.1 | Crear estructura de directorios | Crear `/home/YOUR_USER/cicd/` con subdirectorios scripts/, python/, config/, db/, logs/ | Directorios creados |
...
git:
  ...
  compile_path: /home/YOUR_USER/compile
...
| ID | Subtarea | Descripción | Entregable |
|----|----------|-------------|------------|
| 2.1 | Script compile.sh | Copiar repo a /home/YOUR_USER/compile, dar permisos, ejecutar build | compile.sh |
...
echo "║                                                            ║"
echo "║  Más info: /home/YOUR_USER/cicd/logs/                          ║"
echo "║  SonarQube: https://YOUR_SONARQUBE_SERVER                     ║"
echo "╚═══════════════════════════════════════════════════════════╝"
echo ""
EOF
...
Documentation=https://YOUR_GIT_SERVER/YOUR_ORG/YOUR_REPO
...
# Logging
StandardOutput=append:/home/YOUR_USER/cicd/logs/service.log
StandardError=append:/home/YOUR_USER/cicd/logs/service_error.log
